...
if __name__ == "__main__":
    ...
    #### JAKA PIŁKA? ######
            ...
            if ((pilka_prost.colliderect(paletka1_prost) == True) and ((pygame.time.get_ticks()) - moment_sygnalu) <= 3) or ((pilka_prost.colliderect(paletka1_prost) == True) and blink.value == 1):
                P_PREDKOSC_Y *= -1
